#-----------------------------------------------------------------------------
# Build VTK WebCore module, pointing it to Slicer's VTK
...
if(NOT DEFINED ${proj}_DIR AND NOT ${SUPERBUILD_TOPLEVEL_PROJECT}_USE_SYSTEM_${proj})
  ...
  set(_module_subdir Web/Core)
  set(_module_name WebCore)
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_CACHE_ARGS
	  ...
	  # Required to find vtkWebGLExporter
      -DvtkWebGLExporter_DIR:PATH=${vtkWebGLExporter_DIR}
